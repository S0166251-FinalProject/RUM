...
class AndOperator(BooleanOperator):
    ...
    def __init__(self):
        BooleanOperator.__init__(self, operator.and_, "and")

class OrOperator(BooleanOperator):
    
    def __init__(self):
        BooleanOperator.__init__(self, operator.or_, "or")
...
class GreaterEqualThanOperator(BooleanOperator):
    def __init__(self):
        BooleanOperator.__init__(self, operator.ge, ">=")
    
class SmallerEqualThanOperator(BooleanOperator):
    def __init__(self):
        BooleanOperator.__init__(self, operator.le, "<=")