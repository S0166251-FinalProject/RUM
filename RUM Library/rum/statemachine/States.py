from rum.statemachine.Guards import TrueGuard
...
class State(object):
    ...
    def __setupStateTransitions__(self, states):
        raise NotImplementedError('Classes which inherit from rum.States.State must implement __setupStateTransitions__()')
